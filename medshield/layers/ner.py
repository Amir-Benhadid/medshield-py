...
class NERLayer:
    def __init__(self):
        try:
            ...
            import warnings
            warnings.warn("Spacy model 'en_core_web_sm' not found. NERLayer will be inactive. Run: python -m spacy download en_core_web_sm")
            self.nlp = None

    def process(self, text: str, options: SanitizerOptions, vault: TokenVault) -> Dict[str, Any]:
        ...
        target_labels = {"PERSON": "PERSON", "ORG": "ORGANIZATION", "GPE": "LOCATION", "LOC": "LOCATION"}
